...
def load_raw_dataset(prefix):
    """Load dataset linh hoạt theo tiền tố mới (english_train.csv,...)"""
    data_files = {
...
def main():
    ...
    print(f"\n{'='*50}")
    print(f"PROCESSING DATASET: {prefix.upper()} (RoBERTa)")
    print(f"{'='*50}")
    ...
    print(f"\n✅ Done. RoBERTa tokenized dataset for '{prefix}' saved successfully to disk.")
